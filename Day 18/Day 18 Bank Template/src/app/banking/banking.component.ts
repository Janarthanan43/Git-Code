...
export class BankingComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  transactions: Transaction[] = [
    { date: '2024-01-05', description: 'Purchase', amount: 80 },
    { date: '2024-01-06', description: 'Deposit', amount: 100 },
    { date: '2024-01-07', description: 'Cosmetic', amount: 200 },
    { date: '2024-01-08', description: 'Credit', amount: 2000 },
    { date: '2024-01-09', description: 'Deposit', amount: 500 },
    { date: '2024-01-10', description: 'Deposit', amount: 700 },
